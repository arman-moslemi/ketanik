...
<View style={styles(theme).customRow}>
    ...
    <View style={{flex : 2,textAlign:"right"}}>
          <Text style={styles(theme).menuTitle}>{getTranslation('درباره ما')}</Text>
          </View>
